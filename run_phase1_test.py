...
# 3. Submit Phase 1 job: rgb, lidar, radar
job_payload = {'project_id': pid, 'map': 'Town01', 'sensors': ['rgb', 'lidar', 'radar'], 'frames': 25, 'export_format': 'kitti'}
...
job_id = job_resp['id']
print(f"Submitted Phase 1 job: {job_id}")
