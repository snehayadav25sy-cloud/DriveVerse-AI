...
# 3. Submit Phase 2 Test A job: rgb, depth ONLY
job_payload = {'project_id': pid, 'map': 'Town01', 'sensors': ['rgb', 'depth'], 'frames': 15, 'export_format': 'kitti'}
...
job_id = job_resp['id']
print(f"Submitted Phase 2 Test A job: {job_id}")
