...
# 3. Submit Phase 3 Test A job: rgb, semantic ONLY
job_payload = {'project_id': pid, 'map': 'Town01', 'sensors': ['rgb', 'semantic'], 'frames': 15, 'export_format': 'kitti'}
...
job_id = job_resp['id']
print(f"Submitted Phase 3 Test A job: {job_id}")
