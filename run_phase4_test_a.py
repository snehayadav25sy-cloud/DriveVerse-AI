...
# 3. Submit Phase 4 Test A job: rgb, instance
job_payload = {'project_id': pid, 'map': 'Town01', 'sensors': ['rgb', 'instance'], 'frames': 15, 'export_format': 'kitti'}
...
job_id = job_resp['id']
print(f"Submitted Phase 4 Test A job: {job_id}")
