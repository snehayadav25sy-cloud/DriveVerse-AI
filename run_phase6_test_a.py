...
# 3. Submit Phase 6 Test A job: 4-camera rig
job_payload = {'project_id': pid, 'map': 'Town01', 'sensors': ['camera_front', 'camera_left', 'camera_right', 'camera_rear'], 'frames': 15, 'export_format': 'kitti'}
...
job_id = job_resp['id']
print(f"Submitted Phase 6 Test A job: {job_id}")
