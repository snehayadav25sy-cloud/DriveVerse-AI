...
# 3. Submit job
job_payload = {'project_id': pid, 'map': 'Town01', 'sensors': ['rgb', 'lidar'], 'frames': 25, 'export_format': 'kitti'}
...
# 4. Now process this job with worker logic directly
...
print(f"Picked up job {job.id} for processing...")
job.status = 'running'
db.commit()
...
try:
    ...
    print(f"Dataset generated! output_path={output_path}, rgb={rgb_cnt}, lidar={lid_cnt}, ann={ann_cnt}")
